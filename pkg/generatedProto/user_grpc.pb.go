...
type UserClient interface {
	...
	Whoami(ctx context.Context, in *WhoamiRequest, opts ...grpc.CallOption) (*WhoamiResponce, error)
}
...
func (c *userClient) Whoami(ctx context.Context, in *WhoamiRequest, opts ...grpc.CallOption) (*WhoamiResponce, error) {
	out := new(WhoamiResponce)
	err := c.cc.Invoke(ctx, "/proto.User/Whoami", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	Whoami(context.Context, *WhoamiRequest) (*WhoamiResponce, error)
...
func (UnimplementedUserServer) Whoami(context.Context, *WhoamiRequest) (*WhoamiResponce, error) {
